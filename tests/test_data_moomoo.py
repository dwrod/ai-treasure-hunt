...
class AdapterTests(unittest.TestCase):
    ...
    def test_shape_and_adjustment_convention(self):
        ...
        self.assertEqual(data_moomoo.ADJUST_FORWARD, 1)  # Production API forward adjustment excludes dividends.
        self.assertEqual(params["autype"], 1)
...
class HttpLayerTests(unittest.TestCase):
    ...
    def test_signature_follows_documented_template_and_verifies(self):
        ...
        query = "start=2026-09-01&end=2026-09-08&ktype=2&autype=1&num=370"
